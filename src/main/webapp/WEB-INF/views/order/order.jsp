...
<jsp:include page="../main/header.jsp" />
  ...
  <div class="wrap">
    <div class="section1">
      ...
      <div class="section_con">
        <h4>주문자 정보</h4>
        <input type="text" placeholder="구매자명" style="width:25%; height:30px; margin-top: 10px;" readonly>
        <input type="text" placeholder="phone1 + phone2 + phone3" style="width:50%; height:30px; margin-top: 10px;" readonly>
      </div>
      <div class="section_con" id="del_info">
        ...
        <input type="text" id="sample2_postcode" placeholder="우편번호" style="width:15%; height:30px; margin-top: 10px;">
        <input type="button" onclick="sample2_execDaumPostcode()" value="주소 찾기" style="width:15%; height:30px; margin-top: 10px; padding: 0px;"><br>
        <input type="text" id="sample2_address" placeholder="주소" style="width:30%; height:30px; margin-top: 10px;"><br>
        <input type="text" id="sample2_detailAddress" placeholder="상세주소" style="width:30%; height:30px; margin-top: 10px;">
        <input type="text" id="sample2_extraAddress" placeholder="참고항목" style="width:20%; height:30px; margin-top: 10px;">
      ...
      <div class="section_con">
        ...
        <input type="text" placeholder="배송메모를 입력해 주세요." style="width:95%; height:30px; margin-top: 10px;">
      </div>
    </div>
    <div class="section2">
      <div class="section_con">
      ...
      <div class="section_con" style="height: 60px; padding: 0px;">
        <a href="./basket" onclick="alert('결제되었습니다.')">  <!-- 이후 마이페이지 - 주문내역조회로 이동 -->
          <button style="width: 100%; height: 100%; background-color: rgb(70, 70, 70); 
          border: 1px solid rgb(70, 70, 70); color:white; font-size: 20px;">결제하기</button>
        </a>
      </div>

 ...
 <form action="registerAction" method="POST" onSubmit="return input_check_func();"> 
    <div class="join ">
      ...
      <div class="join_Passwordcheck main Line">
        ...
        <input type="text" class="form-control textbox" name="user_name" id="name">
      ...
      <div class="main Line phonetext">
        ...
        <input type="text" class="form-control textbox "  name="user_phone" id="user_phone">
      </div>
      ...
      <div class="agreeArea">
        ...
        <p class="check"><span class="Utilization">이용약관에 동의하십니까?</span> <input id="agree_service_check0" name="agree_service_check[]" fw-filter="/1/" fw-label="이용약관 동의" fw-msg="이용약관에 동의 하세요" class="ec-base-chk" value="1" type="checkbox"><label for="agree_service_check0">동의함</label></p>
    </div>

    
    <div class="agree">
      <div class="fr-view fr-view-privacy-required">■ 수집하는 개인정보 항목<br>
